...
export default function AddProduct(props) {
    ...
    const [category] = useState(props.res);
    ...
    const value = {
        ...
        'category': parseFloat(selectedCategory)
    }
    ...
    return (
        <>
            ...
            <div>
                ...
                <div className="product_details_title">Product Images <div style={{ display: 'inline-flex' }} onClick={() => setOpen(true)} className="product_image_add_button"><AddIcon /></div></div>
                ...
                <div className="product_category_container">
                    <h4 className='product_details_title'>Categories</h4>
